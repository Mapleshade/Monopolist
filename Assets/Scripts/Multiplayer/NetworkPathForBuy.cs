...
public class NetworkPathForBuy : NetworkStreetPath
{
    ...
    public void Buy(NetworkPlayer player)
    {
    ...
    //конструктор класса
    public NetworkPathForBuy(int idPath, string namePath, int idStreetParent, int renta, Vector3 start, Vector3 end,
        int idPlayer, int[] builds,
        int priceStreetPath, bool isBridge, string nameOfPrefab, bool isBlocked) : base(idPath, namePath,
        idStreetParent, renta, start, end,
    ...
    public void TakeData(NetworkPathForBuy pathForBuy)
    {
